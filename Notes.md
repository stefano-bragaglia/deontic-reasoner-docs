...
| 5-scope-evaluation | 1-predicate-registry-and-condition-evaluation | story/5-scope-evaluation/1-predicate-registry-and-condition-evaluation | pr-open |
...
Await review/merge of [PR #18](https://github.com/stefano-bragaglia/deontic-reasoner/pull/18)
(1-predicate-registry-and-condition-evaluation); on merge, run the story's on-merge steps, then
/stage-a 5-scope-evaluation/2-temporal-scope-evaluation.