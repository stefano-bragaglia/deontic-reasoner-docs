...
| 4-hohfeldian-grounding | 1-norm-atom-and-correlative-rule-grounding | story/4-hohfeldian-grounding/1-norm-atom-and-correlative-rule-grounding | code |
...
Run /pr 4-hohfeldian-grounding/1-norm-atom-and-correlative-rule-grounding to open this story's PR
against feature/4-hohfeldian-grounding (all gates green, 100% coverage).